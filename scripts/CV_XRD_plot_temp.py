...
DaFy_path = os.path.dirname(script_path)
sys.path.append(os.path.join(DaFy_path,'util', 'XRD_tools'))
print(os.path.join(DaFy_path,'util', 'XRD_tools'))
...
for scan_id in scan_ids:
    ...
    for pos in range(len(scan_direction_ranges)):
        ...
        def plot_on_ax(ax,x,data,y_label,ref_max,fit=False):
            ...
            if fit:
                fit_index = np.logical_and(x[indx1:indx2]>1.1, x[indx1:indx2]<1.5)
        ...
        for ax, data, y_label,ref, fit in zip(ip_strain_axs+oop_strain_axs+ip_size_axs+oop_size_axs+intensity_axs,\
                            ...
                            [1]*(len(ip_strain_axs)*2)+[1]*(len(ip_strain_axs)*2)+[1]*(len(ip_strain_axs)*1)):
    ...
    slope_fit_results[scan_id]={}
    slope_fit_results[scan_id]['size'] = [[slope_hor, std_hor],[slope_ver, std_ver]]
    ...
    slope_fit_results[scan_id]['strain'] = [[slope_hor, std_hor],[slope_ver, std_ver]]
...
keys = list(slope_fit_results.keys())
keys.sort()
slope_size_hor = [slope_fit_results[key]['size'][0][0] for key in keys]
slope_size_hor_std = [slope_fit_results[key]['size'][0][1] for key in keys]
slope_size_hor_all_pHs = [slope_size_hor[1]]+slope_size_hor[::2]
slope_size_hor_std_all_pHs = [slope_size_hor_std[1]]+slope_size_hor_std[::2]
slope_size_hor_pH13 = slope_size_hor[1::2]
slope_size_hor_std_pH13 = slope_size_hor_std[1::2]

slope_size_ver = [slope_fit_results[key]['size'][1][0] for key in keys]
slope_size_ver_std = [slope_fit_results[key]['size'][1][1] for key in keys]
slope_size_ver_all_pHs = [slope_size_ver[1]]+slope_size_ver[::2]
slope_size_ver_std_all_pHs = [slope_size_ver_std[1]]+slope_size_ver_std[::2]
slope_size_ver_pH13 = slope_size_ver[1::2]
slope_size_ver_std_pH13 = slope_size_ver_std[1::2]

slope_strain_hor = [slope_fit_results[key]['strain'][0][0] for key in keys]
slope_strain_hor_std = [slope_fit_results[key]['strain'][0][1] for key in keys]
slope_strain_hor_all_pHs = [slope_strain_hor[1]]+slope_strain_hor[::2]
slope_strain_hor_std_all_pHs = [slope_strain_hor_std[1]]+slope_strain_hor_std[::2]
slope_strain_hor_pH13 = slope_strain_hor[1::2]
slope_strain_hor_std_pH13 = slope_strain_hor_std[1::2]

slope_strain_ver = [slope_fit_results[key]['strain'][1][0] for key in keys]
slope_strain_ver_std = [slope_fit_results[key]['strain'][1][1] for key in keys]
slope_strain_ver_all_pHs = [slope_strain_ver[1]]+slope_strain_ver[::2]
slope_strain_ver_std_all_pHs = [slope_strain_ver_std[1]]+slope_strain_ver_std[::2]
slope_strain_ver_pH13 = slope_strain_ver[1::2]
slope_strain_ver_std_pH13 = slope_strain_ver_std[1::2]

ax_size_hor_slope = fig_slope.add_subplot(411)
ax_size_ver_slope = fig_slope.add_subplot(412)
ax_strain_hor_slope = fig_slope.add_subplot(413)
ax_strain_ver_slope = fig_slope.add_subplot(414)

# ax_size_hor_pH13_slope = fig_slope.add_subplot(422)
# ax_size_ver_pH13_slope = fig_slope.add_subplot(424)
# ax_strain_hor_pH13_slope = fig_slope.add_subplot(426)
# ax_strain_ver_pH13_slope = fig_slope.add_subplot(428)

ax_size_hor_slope.errorbar(x = [0,1,3,5], y = slope_size_hor_all_pHs, yerr = slope_size_hor_std_all_pHs, fmt = 'o-g')
ax_size_hor_slope.set_title('hor_size')
ax_size_hor_slope.set_xticks([0,1,3,5])
ax_size_hor_slope.set_xticklabels(['pH 13','pH 10', 'pH 8', 'pH 7'])

ax_size_ver_slope.errorbar(x = [0,1,3,5], y = slope_size_ver_all_pHs, yerr = slope_size_ver_std_all_pHs, fmt = 'o-g')
ax_size_ver_slope.set_title('ver_size')

ax_strain_hor_slope.errorbar(x = [0,1,3,5], y = slope_strain_hor_all_pHs, yerr = slope_strain_hor_std_all_pHs, fmt = 'o-g')
ax_strain_hor_slope.set_title('hor_strain')

ax_strain_ver_slope.errorbar(x = [0,1,3,5], y = np.array(slope_strain_ver_all_pHs), yerr = np.array(slope_strain_ver_std_all_pHs), fmt = 'o-g')
ax_strain_ver_slope.set_title('ver_strain')

ax_size_hor_slope.errorbar(x = [2,4,6], y = slope_size_hor_pH13, yerr = slope_size_hor_std_pH13, fmt = 'o-r')
ax_size_hor_slope.set_title('hor_size')
ax_size_hor_slope.set_xticks([2,4,6])
ax_size_hor_slope.set_xticklabels(['pH 13', 'pH 13', 'pH 13'])

ax_size_ver_slope.errorbar(x = [2,4,6], y = slope_size_ver_pH13, yerr = slope_size_ver_std_pH13, fmt = 'o-r')
ax_size_ver_slope.set_title('ver_size')

ax_strain_hor_slope.errorbar(x = [2,4,6], y = slope_strain_hor_pH13, yerr = slope_strain_hor_std_pH13, fmt = 'o-r')
ax_strain_hor_slope.set_title('hor_strain')

ax_strain_ver_slope.errorbar(x = [2,4,6], y = np.array(slope_strain_ver_pH13), yerr = np.array(slope_strain_ver_std_pH13), fmt = 'o-r')
ax_strain_ver_slope.set_title('ver_strain')
'''
plt.legend()
plt.show()
