...
for scan_no in scan_nos:
    ...
    for frame_number in frame_number_ranges:
        ...
        #launch peak fitting
        check_result = peak_fit_engine.reset_fit(img, use_first_fit_for_pos, check = False)
        ...
        if tweak_mode:
            fig_3_plot = show_3_plots(fig_3_plot,peak_fit_engine.img,peak_fit_engine.grid_q_ip,peak_fit_engine.grid_q_oop,\
                                      vmin = vmin_2d_img, vmax =vmax_2d_img, cmap = 'jet', is_zap_scan = is_zap_scan,\
            ...
            plt.pause(0.05)
            plt.show()
            plot_lib = {'vmin':vmin_2d_img, 'vmax':vmax_2d_img, 'cmap':'jet','is_zap_scan':is_zap_scan, \
